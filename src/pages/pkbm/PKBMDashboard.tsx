...
const PKBMDashboard: React.FC = () => {
        ...
        datasets: [
            {
                ...
                backgroundColor: 'rgba(16, 185, 129, 0.5)', // Green for students
            },
        ],
    };
    ...
    return (
        <div className="space-y-6">
            <h1 className="text-2xl font-bold text-gray-900">Dashboard PKBM</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <p className="text-gray-500 text-sm">Total User (Admin/Guru)</p>
                    <p className="text-3xl font-bold text-purple-600">{stats.total_users}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <p className="text-gray-500 text-sm">Rata-rata Nilai Unit</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <h3 className="text-lg font-bold mb-4">Top 5 Siswa Berprestasi</h3>
                    <Bar options={{ responsive: true, indexAxis: 'y' as const }} data={chartData} />
                </div>
